...
//            Log.d("mWeatherId",weatherString);
        ...
        swipeRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                SharedPreferences prefsl = PreferenceManager.getDefaultSharedPreferences(WeatherActivity.this);
                String weatherStringl = prefsl.getString("weather",null);
                Weather weatherl = Utility.handleWeatherResponse(weatherStringl);
                mWeatherId = weatherl.basic.weatherId;
                requestWeather(mWeatherId);
            }
        });
